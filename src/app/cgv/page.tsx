    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400">
          At our company, we take the privacy and security of your personal data very seriously. This page provides you
          with information about the General Data Protection Regulation (GDPR) and our privacy policy, so you can
      ...
      <div id="rgpd">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          The General Data Protection Regulation (GDPR) is a comprehensive data protection law that came into effect in
          the European Union in 2018. It aims to give individuals more control over their personal data and ensure that
      ...
      <div id="privacy">
        ...
        <div className="mt-4 space-y-4">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              We may collect personal information from you when you use our services, such as your name, email address,
              and other contact details. We may also collect information about your usage of our website and services,
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              We use your personal data to provide and improve our services, communicate with you, and comply with legal
              and regulatory requirements. We do not sell or share your personal data with third parties for their own
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              ...
              modification, or disclosure. This includes using encryption, access controls, and regular security audits.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-bold">Your Rights</h3>
            <p className="text-gray-500 dark:text-gray-400">
              You have the right to access, rectify, or delete your personal data, as well as to object to or restrict
              the processing of your data. You can exercise these rights by contacting us at [email protected]
            </p>
          </div>
        </div>
      </div>
